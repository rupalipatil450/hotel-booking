    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-2">
          ...
          <p
            className="text-xs font-inter py-1.5 
             px-3 text-white bg-orange-500 rounded-full"
          >
            20% OFF
          </p>
        </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap items-center mt-3 mb-6 gap-4">
              {room.amenities.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center gpa-2 px-3 py-2
        ...
        >
          ...
          <button
           ...
           max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base
           cursor-pointer"
          >
            Check Availability
          </button>
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sed ab neque
          maxime pariatur iste harum nam accusamus incidunt, voluptas doloremque
          qui recusandae, similique facere error culpa animi! Id, suscipit sint.
          maxime pariatur iste harum nam accusamus incidunt, voluptas doloremque
          qui recusandae, similique facere error culpa animi! Id, suscipit sint.
        </div>
