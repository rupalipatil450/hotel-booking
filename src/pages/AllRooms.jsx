...
const CheckBox = ({ label, selected = false, onChange = () => {} }) => {
  return (
    <label className="flex gap-3 items-center cursor-pointer mt-2 text-sm">
      ...
      />
      <span className="font-light select-name">{label}</span>
    </label>
  );
};
      ...
      <div>
        <div className="flex flex-col items-start text-left">
          ...
          <p className="text-sm md:text-base text-gray-500/90 mt-2">
            ...
            dolore accusantium aliquid ab nesciunt reiciendis suscipit, minus
            iste commodi possimus ea laudantium
          </p>
        </div>
        ...
        {roomsDummyData.map((room) => (
          ...
          >
            <img
              ...
              className="max-h-65 md:w-1/2 rounded-xl shadow-lg object-coevr cursor-pointer"
            />
            <div className="flex flex-col md:w-1/2 gap-2">
              ...
              {/* Room Aminities */}
              <div className="flex flex-wrap items-centercmt-3 mb-6 gap-4">
      ...
      >
        <div
          className={`flex items-center justify-between px-5 py-2.5 
            lg:border border-gray-300 ${openFilters && "border-b"}`}
        >
