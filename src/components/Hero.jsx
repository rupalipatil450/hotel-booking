...
const Hero = () => {
  return (
    ...
    >
      <p className="bg-[#49B9FF]/50 px-3.5 rounded-full mt-20">
      ...
      <p className="max-w-130 mt-2 text-sm md:text-base">
        ...
        aliquam sed, dicta quasi magni enim cum asperiores, beatae omnis velit
        molestiae eaque esse cupiditate hic odio deleniti dignissimos sapiente!
      </p>
